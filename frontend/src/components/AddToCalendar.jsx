...
export default function AddToCalendar({ lesson, onClose }) {
    ...
    return (
        <div
            ref={popupRef}
            className="absolute right-0 top-full mt-2 z-50 bg-white dark:bg-gray-800 rounded-xl shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden min-w-[200px] animate-in fade-in slide-in-from-top-2"
        >
            ...
            {showSuccess ? (
                ...
                <div className="p-2">
                    <button
                        ...
                        className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
                    >
                        ...
                        <span className="text-sm font-medium text-gray-900 dark:text-white">Apple Calendar</span>
                    </button>
                    ...
                    <button
                        ...
                        className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
                    >
                        <div className="w-8 h-8 bg-white border border-gray-200 dark:border-gray-600 rounded-lg flex items-center justify-center">
