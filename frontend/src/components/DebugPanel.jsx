  ...
  return (
    <div className="fixed bottom-4 right-4 z-50">
      <button
        ...
        className="bg-yellow-500 dark:bg-yellow-600 text-white px-4 py-2 rounded-lg shadow-lg text-sm font-medium"
      >
        🐛 Debug {expanded ? '▼' : '▲'}
      </button>

      {expanded && (
        <div className="absolute bottom-12 right-0 w-80 bg-white dark:bg-gray-800 rounded-lg shadow-xl border border-gray-200 dark:border-gray-700 p-4 max-h-96 overflow-auto">
          <h3 className="font-bold text-gray-900 dark:text-white mb-3">Debug Panel</h3>

          <div className="space-y-3">
            <button
              onClick={runEncodingTest}
              disabled={loading}
              className="w-full bg-blue-500 dark:bg-blue-600 text-white px-3 py-2 rounded text-sm font-medium disabled:opacity-50"
            >
            ...
            <button
              ...
              className="w-full bg-red-500 dark:bg-red-600 text-white px-3 py-2 rounded text-sm font-medium"
            >
              Disable Debug
            </button>
            ...
            <div className="mt-3 pt-3 border-t border-gray-200 dark:border-gray-700">
              <h4 className="font-medium text-gray-700 dark:text-gray-300 mb-2">Page Info</h4>
              <ul className="text-xs text-gray-600 dark:text-gray-400 space-y-1">
