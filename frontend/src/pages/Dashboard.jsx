      ...
      <div ref={containerRef} className="flex-1 overflow-y-auto p-4 lg:p-6">
        <div className="max-w-6xl mx-auto fade-in">
          <div className="grid grid-cols-3 gap-3 mb-6">
            <Link to="/notifications" className="card-hover">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-primary-600 dark:text-primary-400">{unreadNotifications}</p>
                </div>
            ...
            <Link to="/messages" className="card-hover">
              <div className="flex items-center justify-between">
                <div>
                ...
                <div className="w-12 h-12 rounded-full flex items-center justify-center icon-bg-green">
