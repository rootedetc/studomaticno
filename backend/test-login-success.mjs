...
async function testLoginSuccess() {
  ...
  try {
    ...
    formData.append('login', 'YOUR_USERNAME');  // Replace with actual username
    formData.append('password', 'YOUR_PASSWORD');  // Replace with actual password
    ...
    console.log('valCustom after login:');
    ...
    if (hasUser) {
      ...
      console.log('Program:', $response('#labProgram').text());
